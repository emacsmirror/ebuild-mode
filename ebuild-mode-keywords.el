...
;; regexp size. See also the comment in keyword-generation.sh.
...
(defvar ebuild-mode-keywords-eclass
  '(((
      ...
      ;; common-lisp-3
      "absolute-path-p" "common-lisp-3_src_compile"
      "common-lisp-3_src_install" "common-lisp-export-impl-args"
      "common-lisp-find-lisp-impl" "common-lisp-get-fpredicate"
      ...
      "filter-mfpmath" "get-flag" "is-flag" "is-flagq" "is-ldflag"
      "is-ldflagq" "no-as-needed" "raw-ldflags" "replace-cpu-flags"
      "replace-flags" "replace-sparc64-flags" "strip-flags"
      "strip-unsupported-flags" "test-flag-CC" "test-flag-CCLD"
      ...
      "linux-info_pkg_setup" "linux_chkconfig_builtin"
      "linux_chkconfig_module" "linux_chkconfig_present"
      "linux_chkconfig_string" "linux_config_bin_exists" "linux_config_exists"
      "linux_config_path" "linux_config_qa_check" "linux_config_src_exists"
      "qeerror" "qeinfo" "qewarn" "qout" "require_configured_kernel"
      ...
      "linux-mod_src_install" "move_old_moduledb" "remove_moduledb"
      "set_kvobj" "strip_modulenames" "update_depmod" "update_moduledb"
      "use_m"
      ;; llvm
      ...
      ;; meson
      "meson_feature" "meson_install" "meson_src_compile"
      "meson_src_configure" "meson_src_install" "meson_src_test" "meson_use"
      ;; meson-multilib
      ...
      "mozlinguas_src_compile" "mozlinguas_src_install"
      ...
      ;; multilib
      "get_abi_CFLAGS" "get_abi_CHOST" "get_abi_CTARGET"
      "get_abi_FAKE_TARGETS" "get_abi_LDFLAGS" "get_abi_LIBDIR" "get_all_abis"
      "get_all_libdirs" "get_exeext" "get_install_abis" "get_libname"
      ...
      "perl_fix_permissions" "perl_get_module_version"
      "perl_get_raw_vendorlib" "perl_get_vendorlib" "perl_get_wikiurl"
      "perl_get_wikiurl_features" "perl_get_wikiurl_tests" "perl_has_module"
      "perl_has_module_version" "perl_link_duallife_scripts"
      ...
      "qt5_get_mkspecsdir" "qt5_get_plugindir"
      ;; qt5-build
      "qt5-build_pkg_postinst" "qt5-build_pkg_postrm" "qt5-build_src_compile"
      "qt5-build_src_configure" "qt5-build_src_install"
      "qt5-build_src_prepare" "qt5-build_src_test"
      ...
      ;; rebar
      "erebar" "get_erl_libs" "rebar_disable_coverage"
      "rebar_fix_include_path" "rebar_remove_deps" "rebar_set_vsn"
      "rebar_src_compile" "rebar_src_configure" "rebar_src_install"
    ...
    ((
      ...
      "toolchain_src_configure" "toolchain_src_install"
      ...
      "tc-getBUILD_CXX" "tc-getBUILD_LD" "tc-getBUILD_NM"
      "tc-getBUILD_OBJCOPY" "tc-getBUILD_PKG_CONFIG" "tc-getBUILD_PROG"
      "tc-getBUILD_RANLIB" "tc-getBUILD_READELF" "tc-getBUILD_STRINGS"
      ...
      "tc-getRANLIB" "tc-getRC" "tc-getREADELF" "tc-getSTRINGS" "tc-getSTRIP"
      "tc-getTARGET_CPP" "tc-has-openmp" "tc-has-tls" "tc-is-clang"
      "tc-is-cross-compiler" "tc-is-gcc" "tc-is-softfloat" "tc-is-static-only"
      "tc-ld-disable-gold" "tc-ld-force-bfd" "tc-ld-is-gold" "tc-ld-is-lld"
