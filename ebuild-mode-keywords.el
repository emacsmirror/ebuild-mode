...
(defvar ebuild-mode-font-lock-keywords
  (mapcar
   ...
   (list ebuild-mode-keywords-sandbox
	 ...
	 ebuild-mode-keywords-perl-app
	 ebuild-mode-keywords-perl-module
	 ebuild-mode-keywords-distutils
	 ebuild-mode-keywords-games-etmod
	 ebuild-mode-keywords-games-mods
	 ebuild-mode-keywords-games-q3mod
	 ebuild-mode-keywords-games-ut2k4mod
	 ebuild-mode-keywords-games
	 ebuild-mode-keywords-depend-apache
	 ebuild-mode-keywords-apache-module
	 ebuild-mode-keywords-kernel-2
	 ebuild-mode-keywords-kernel-mod
	 ebuild-mode-keywords-check-kernel
	 ebuild-mode-keywords-mysql
	 ebuild-mode-keywords-mysql_fx
	 ebuild-mode-keywords-gst-plugins10
	 ebuild-mode-keywords-gst-plugins
	 ebuild-mode-keywords-gnustep-funcs
	 ebuild-mode-keywords-php-ext-base-r1
	 ebuild-mode-keywords-php-common-r1
	 ebuild-mode-keywords-php-ext
	 ebuild-mode-keywords-php-pear-r1
	 ebuild-mode-keywords-php-sapi
	 ebuild-mode-keywords-php5-sapi-r3
	 ebuild-mode-keywords-toolchain
	 ebuild-mode-keywords-toolchain-binutils
	 ebuild-mode-keywords-toolchain-funcs
	 ebuild-mode-keywords-eutils
	 ebuild-mode-keywords-bash-completion
	 ebuild-mode-keywords-gnome2-utils
	 ebuild-mode-keywords-gnome2
	 ebuild-mode-keywords-fdo-mime
	 ebuild-mode-keywords-java-ant-2
	 ebuild-mode-keywords-java-utils-2
	 ebuild-mode-keywords-alternatives
	 ebuild-mode-keywords-pam
	 ebuild-mode-keywords-mozilla-launcher
	 ebuild-mode-keywords-mozconfig
	 ebuild-mode-keywords-mozconfig-2
	 ebuild-mode-keywords-mozcoreconf
	 ebuild-mode-keywords-mozextensions
	 ebuild-mode-keywords-db
	 ebuild-mode-keywords-db4-fix
	 ebuild-mode-keywords-db-use
	 ebuild-mode-keywords-xfce44
	 ebuild-mode-keywords-autotools
	 ebuild-mode-keywords-bzr
	 ebuild-mode-keywords-cvs
	 ebuild-mode-keywords-subversion
	 ebuild-mode-keywords-git
	 ebuild-mode-keywords-rpm
	 ebuild-mode-keywords-mercurial
	 ebuild-mode-keywords-ruby
	 ebuild-mode-keywords-qt3
	 ebuild-mode-keywords-qt4
	 ebuild-mode-keywords-freebsd
	 ebuild-mode-keywords-cron
	 ebuild-mode-keywords-libtool
	 ebuild-mode-keywords-fixheadtails
	 ebuild-mode-keywords-webapp
	 ebuild-mode-keywords-64-bit
	 ebuild-mode-keywords-darcs
	 ebuild-mode-keywords-nsplugin
	 ebuild-mode-keywords-latex-package
	 ebuild-mode-keywords-gtk-sharp-component
	 ebuild-mode-keywords-libtool
	 ebuild-mode-keywords-kde
	 ebuild-mode-keywords-kde-meta
	 ebuild-mode-keywords-kde-functions
	 ebuild-mode-keywords-x11
	 ebuild-mode-keywords-vim
	 ebuild-mode-keywords-vim-doc
	 ebuild-mode-keywords-vim-plugin
	 ebuild-mode-keywords-confutils
	 ebuild-mode-keywords-linux-info
	 ebuild-mode-keywords-linux-mod
	 ebuild-mode-keywords-common-lisp-common-3
	 ebuild-mode-keywords-common-lisp-common-2
	 ebuild-mode-keywords-common-lisp-common
	 ebuild-mode-keywords-common-lisp
	 ebuild-mode-keywords-multilib
	 ebuild-mode-keywords-eclass
	 ebuild-mode-keywords-versionator
	 ebuild-mode-keywords-flag-o-matic
